...
class Size(wx.Frame):
	def __init__(self, parent, id_):
		...
		self.txt9xa = wx.TextCtrl(self.panel, -1, pos=(round(8*x), round(23*x)), size=(round(2.5*x), round(x-y)))
		self.button19xa = wx.Button(self.panel, -1, "Browse", pos=(round(10.5*x),round(23*x)), size=(round(2.5*x), round(x-y)))
		self.button19xa.Bind(wx.EVT_BUTTON, self.OnOpenDEM)
		self.Convert=wx.Button(self.panel, label="Convert", pos=(round(13*x),round(23*x)), size=(round(2.5*x), round(x-y)))
		...
		self.runbutton=wx.Button(self.panel, label="Start", pos=(round(10),round(22*x)), size=(round(2.5*x), round(x-y)))
		self.clearbutton=wx.Button(self.panel, label="Clear", pos=(8*x,22*x), size=(round(2.5*x), x-y))
		self.endbutton=wx.Button(self.panel, label="End", pos=(13*x,22*x), size=(round(2.5*x), x-y))
		...
		self.button19a = wx.Button(self.panel, -1, "Browse", pos=(13*x,21*x), size=(round(2.5*x), x-y))
		...
		self.panel.SetScrollbars( 150, 90,  10, 10 )
