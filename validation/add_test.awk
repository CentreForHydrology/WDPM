#!/usr/bin/awk -f 
# Tests results of WDPM add module
# (c) Kevin Shook, 2021
...
specified_volume=(add_depth / 1000) * cellcount *  cellsize * cellsize;
vol_error=abs(total_volume - specified_volume) / specified_volume
patch_depth_error=abs(patch_depth - specified_patch_depth) / specified_patch_depth
print("");
print("Add module test");
print("===============");
